...
echo '<meta HTTP-EQUIV="REFRESH" content="0; url=admin.php?page=Settings&tab=cert&status='.$decoded->status.'&reason='.$decoded->reason.'">';
...
;
	...
	echo '<meta http-equiv="refresh" content="0; url=admin.php?page=Settings&tab=cert">';
}
?>
